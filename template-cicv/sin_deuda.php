		...
		<div class="container">
			...
			<div class="row justify-content-center mt-5 mb-5">
				<div class="col-md-4 text-center shadow-lg p-5 bg-white rounded">
					...
					<div class="mb-3">
						<h2 class="heading-check">El RUT ingresado no tiene deuda.</h2>
					</div>
					<div class="col mb-3 ms-auto">
						<button id="btnvolver" class="btn btn-primary w-100">VOLVER</button>
					</div>
					<div class="col mb-3 ms-auto">
						Para más información puedes escribirnos a nuestro correo: <b><a class="linked" href="email:correo_contacto@cicv.cl">correo_contacto@cicv.cl</a></b>
					</div>
				</div>
			</div>
		</div>
