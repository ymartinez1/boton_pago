<?php
	...
	if($_SESSION["logueado"] == TRUE) {
		...
		$rutFinal = $_SESSION["rutAlumno"];

		$final = "UPDATE pago_en_linea SET pagado='Pagado' WHERE rutAlumno='$rutFinal';";
		$ejecutaFinal = $mysqli->query($final);
		?>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<div class="contact100-form">
				...
				<div class="showInfo">
					<!--
					<label class="label-input102" style="text-align: justify;">Estamos procesando tu pago, dentro de los próximos minutos recibirás un correo con el comprobante.</b></label>
					-->
					<label class="contact100-form-title" style="text-align: center;">Estamos procesando tu pago.</b></label>
					<label class="contact100-form-title" style="text-align: center;">Pronto contactaremos con usted.</b></label>
				</div>

				<form autocomplete="off" action="#" method="POST" style="width: 100%">
					<div class="container-contact100-form-btn">
						<button id="btnFin" name="btnFin" class="contact100-form-btn" formaction="fin.php">
							Volver
						</button>
					</div>
				</form>
